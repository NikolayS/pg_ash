...
revoke execute on function
  ...
  pg_advisory_lock_shared(int4, int4),
  pg_advisory_xact_lock_shared(bigint),
  pg_advisory_xact_lock_shared(int4, int4),
  pg_try_advisory_lock_shared(bigint),
  pg_try_advisory_lock_shared(int4, int4),
  pg_try_advisory_xact_lock_shared(bigint),
  pg_try_advisory_xact_lock_shared(int4, int4)
from public;
```
