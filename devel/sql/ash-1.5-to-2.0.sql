/*
 * pg_ash: development upgrade from 1.5 or any 2.0 prerelease to the 2.0 candidate
 *
 ...
 *   * stamps ash.config.version with the development installer identity (and the column default), and
 ...
 *
 * The staged installer owns the candidate API, lifecycle and storage changes.
 * Normalization includes sample_unlogged while retaining operator choices.
 * Promote this file with its tested installer at release stamp time; change
 * the relative include below to ../ash-install.sql in sql/migrations/.
